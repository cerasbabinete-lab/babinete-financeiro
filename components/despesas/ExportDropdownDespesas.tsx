// ============================================================
// components/despesas/ExportDropdownDespesas.tsx
// Projeto: Ceras Babinete — Gestão Financeira
// Módulo: Despesas
// Função: Botão "Exportar" com dropdown CSV / Excel
//         Exporta a lista atualmente filtrada
// FEATURE (a pedido do usuário): réplica exata do padrão já usado em
// components/receitas/ExportDropdownReceitas.tsx (e também em Contas a
// Receber, Clientes, Fornecedores)
// Conecta com: DespesasHeader.tsx (desktop), BasebarDespesas.tsx (mobile)
//              despesasService.ts (exportarCSV, exportarExcel)
// ============================================================

'use client'

import { useEffect, useRef, useState } from 'react'
import { exportarCSV, exportarExcel } from '@/lib/despesasService'
import type { Despesa } from '@/types/despesas'

interface ExportDropdownDespesasProps {
  despesas: Despesa[]
  usuario: string
  mobile?: boolean
}

export default function ExportDropdownDespesas({
  despesas,
  usuario,
  mobile = false,
}: ExportDropdownDespesasProps) {
    ...
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {aberto && (
        <div style={{
          ...
          <button
            onClick={() => { exportarCSV(despesas, usuario); setAberto(false) }}
            style={btnItemStyle}
          ...
          <button
            onClick={() => { exportarExcel(despesas, usuario); setAberto(false) }}
