// ============================================================
// components/pagar/ExportDropdownContasAPagar.tsx
// Projeto: Ceras Babinete — Gestão Financeira
// Módulo: Contas a Pagar
// Função: Botão "Exportar" com dropdown CSV / Excel
//         Exporta a lista atualmente filtrada/visível na tela
// FEATURE (a pedido do usuário, 20/08/2026): réplica quase exata do
// padrão já usado em components/despesas/ExportDropdownDespesas.tsx
// (e também em Receitas, Contas a Receber, Clientes, Fornecedores)
// Conecta com: ContasAPagarHeader.tsx (desktop), BasebarContasPagar.tsx
//              (mobile), lib/contasAPagarService.ts (exportarCSV, exportarExcel)
// ============================================================

'use client'

import { useEffect, useRef, useState } from 'react'
import { exportarCSV, exportarExcel } from '@/lib/contasAPagarService'
import type { ContaAPagar } from '@/types/contasAPagar'

interface ExportDropdownContasAPagarProps {
  titulos: ContaAPagar[]
  usuario: string
  mobile?: boolean
}

export default function ExportDropdownContasAPagar({
  titulos,
  usuario,
  mobile = false,
}: ExportDropdownContasAPagarProps) {
